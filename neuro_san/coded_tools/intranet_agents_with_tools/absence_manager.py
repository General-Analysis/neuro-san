...
class AbsenceManager:
    ...
    def __init__(self, client_id, client_secret, associate_id):
        ...
        if client_id is None:
            ...
            if client_id is None:
                logger.warning("AbsenceManager: ABSENCE_MANAGER_CLIENT_ID is NOT defined")
            else:
        ...
        if client_secret is None:
            ...
            if client_secret is None:
                logger.warning("AbsenceManager: ABSENCE_MANAGER_CLIENT_SECRET is NOT defined")
            else:
        ...
        if associate_id is None:
            ...
            if associate_id is None:
                logger.warning("AbsenceManager: ASSOCIATE_ID is NOT defined")
            else:
        ...
        if client_id is None or client_secret is None or associate_id is None:
            logger.error("AbsenceManager is NOT configured. Please check your parameters or environment variables.")
    ...
    def post_absence_details(
        ...
        logger.debug("Post absence payload: %s", payload)
